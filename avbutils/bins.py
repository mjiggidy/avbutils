...
class BinColumnFieldIDs(enum.Enum):
	...
	VendorAssetID = 115
	VendorAssetName = 116
	VendorAssetRights = 117
	VendorAssetPrice = 118
	VendorOriginalMaster = 119
	VendorAssetDescription = 120
	VendorAssetKeywords = 121
	VendorAssetStatus = 122
	VendorInvoiceID = 123
	VendorDownloadMaster = 124
	S3DAlignment = 125
	ImageFraming = 127
	RasterDimension = 128
	ImageSize = 129
	...
	FrameCountStart = 135
	FrameCountEnd = 136
	FrameCountDuration = 137
	VideoDataRate = 139
	BINStart = 141
	BINEnd = 142
	BINTracks = 143
	ChromaSubsampling = 144
	MediaFilePath = 145
	ProxyOffline = 146
	ProxyAudio = 147
	ProxyVideo = 148
